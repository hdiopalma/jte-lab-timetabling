...
class GeneticLocalSearch(GeneticAlgorithm):
    ...
    def __str__(self):
        return f"GeneticLocalSearch(factory={self.factory}, population_size={self.population_size}, selection_manager={self.selection_manager}, crossover_manager={self.crossover_manager}, mutation_manager={self.mutation_manager}, repair_manager={self.repair_manager}, elitism_size={self.elitism_size}, local_search={self.local_search})"
